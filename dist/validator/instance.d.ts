...
export declare type Interface<InstanceT extends Class<object, unknown[]>, MessageT = unknown> = Validator<any, InstanceT, InstanceofValidatable<any, InstanceT, MessageT>> & Message<(result: Omit<Return<any, any, InstanceT>, 'message'>) => MessageT>;
export default class Instanceof<InstanceT extends Class<object, unknown[]> = Class<object, unknown[]>, MessageT = unknown> implements Interface<InstanceT, MessageT> {
    instance: InstanceT;
